...
challenge_list = [ 1, 2, 3, 4, 5, 6 ] 
new_integer = int(input("Enter an integer:"))
replaced_integer = challenge_list.index(3)
challenge_list[replaced_integer] = new_integer
...
shopping = []
shopping.append("goldfish")
shopping.append("crackers")
